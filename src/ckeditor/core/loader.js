	...
	CKEDITOR.loader = ( function() {
		...
		var scripts = {
			...
			'ckeditor': [
				...
				'extensions/dom.nodelist', 'extensions/dom.documentfragment'
			],
			'ckeditor_base': [],
			...
			'dom/document': [ 'dom/node', 'dom/window', 'csp' ],
			'dom/documentfragment': [ 'dom/element' ],
			'dom/element': [ 'dom', 'dom/document', 'dom/domobject', 'dom/node', 'dom/nodelist', 'tools', 'csp' ],
			...
			'extensions/dom.documentfragment': [
				'tools', 'dom/documentfragment', 'dom/nodelist', 'extensions/dom.nodelist'
			]
		};
